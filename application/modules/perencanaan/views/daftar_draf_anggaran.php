                    ...
                    <div class="table-responsive">
                      <table id="test" class="table table-striped table-bordered display nowrap"  style="width:100%">
                        ...
                        <tr>
                          ...
                          <div class="badges">
                          <span class="badge badge-warning"><i class="fa fa-loading"></i> Ditolak</span>
                          <?php } ?>
                        
                          </td>
                          <td>
                          <a href="<?php echo base_url(); ?>perencanaan/rab_datadukung/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-primary "> <i class="fas fa-eye"></i> Lihat</a>
                          </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
