...
class Perencanaan extends MY_Controller
{
  ...
  // TAMBAH SUBKOMPONEN
  public function tambahakunkegiatan()
  {
    $data = $this->session->userdata();
    $data['title'] = 'Tambah Akun Kegiatan';
    // $data['user'] = $this->m_perencanaan->rekap()->result_array();
    $data['user'] = $this->db->get('kode_subkomponen')->result_array();

    $this->load->view('template/header', $data);
    $this->load->view('template/navbar', $data);
    $this->load->view('template/sidebar_perencanaan');
    $this->load->view('tambahakunkegiatan', $data);
    $this->load->view('template/footer');
  }
  ...
  public function aksi_tambah_kode_akun_kegiatan()
  {
    $kode = $this->uri->segment(3);
    // cari nama kegiatan
    ...
    $this->m_perencanaan->insert_data('kode_subkomponen', $data);
    redirect('perencanaan/tambahakunkegiatan');
  }
