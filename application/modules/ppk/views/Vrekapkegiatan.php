                      ...
                      <tbody>
                        ...
                        echo "!!!";
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url(); ?>ppk/kirim_peringatan/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-success btn-sm"><i class="fas fa-paper-plane"></i> Kirim Peringatan </a>
                            <?php }elseif ($users['peringatan_ppk'] ==0 and $users['peringatan_ppspm'] ==1) {  ?>
                            <a href="<?php echo base_url(); ?>ppk/kirim_peringatan/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-success btn-sm"><i class="fas fa-paper-plane"></i> Kirim Peringatan </a>
                            <?php } ?>
                          </td>
                      </tr>
