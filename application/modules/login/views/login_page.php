...
<head>
  ...
  <title>Login &mdash; Sistem Informasi Serapan Anggaran Politeknik Negeri Subang</title>
  <style>
      body{
        background-image: url(./assets/login/polsub.png);
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?= base_url('assets/login/logo_polsub.png')?>" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>

            <div class="card card-primary">
              <div class="card-header"><h4>Login Sistem Informasi Serapan Anggaran Politeknik Negeri Subang</h4></div>
            ...
            <div class="simple-footer">
              Copyright &copy; Politeknik Negeri Subang 2022
            </div>
          </div>
        </div>
      </div>
