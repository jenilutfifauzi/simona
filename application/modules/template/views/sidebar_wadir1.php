          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?php echo base_url('Wadir1/usulan_anggaran_thn') ?>">Usulan Anggaran Tahunan</a></li>
                </ul>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?php echo base_url('Wadir1/usulan_anggaran_thn_keg_baru') ?>">Usulan Kegiatan Baru</a></li>
                </ul>
              </li>
