                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      ...
                      <tr>
                          ...
                          <a href="<?php echo base_url(); ?>direktur/aksi_validasi/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-check-circle"></i> Validasi</a>
                          

                          <a href="<?php echo base_url(); ?>direktur/revisi/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Revisi </a>
                          <?php }else { ?>
