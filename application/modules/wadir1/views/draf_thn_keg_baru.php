                    ...
                    <div class="table-responsive">
                      ...
                      <tr>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url(); ?>Wadir1/lihat_rab/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i> Lihat</a>
                          </td>
                          <td>

                          <?php if ($users['wadir1'] == 0) { ?>
                          <a href="<?php echo base_url(); ?>Wadir1/aksi_validasi_keg_baru/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-check-circle"></i> Validasi</a>
                          

                          <a href="<?php echo base_url(); ?>Wadir1/revisi_keg_baru/<?php echo $users['kode_subkomponen']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Revisi </a>
                          <?php }else { ?>
