...
class Unit extends MY_Controller {
  ...
  //dokumen
    ...
    public function hapus_rab_datadukung()
    {
        ...
        Data RAB dan Data Dukung Berhasil Dihapus <button type= "button" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button>
        </div>');
        redirect('unit/kelola_kegiatan/'.$kode.''); 
    }
    public function hapus_rab_datadukung_keg_baru()
    {
        ...
        redirect('unit/kelola_komponen_keg_baru/'.$kode.''); 
    }
    //submit keg baru
