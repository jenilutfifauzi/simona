                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('unit/aksi_edit_penggunanaan/' . $tb_rab_penggunaan['kode'] ) ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control inputtags" value="<?= 'Rp. '.$tb_rab_penggunaan['total_biaya'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="file" class="form-control inputtags" name="bukti" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Komentar</label>
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control inputtags" name="komentar" value="<?php if ($tb_rab_penggunaan['komentar'] == null){ echo "Tidak ada komentar";}else {echo $tb_rab_penggunaan['komentar'];} ?>" readonly>
                                            </div>
                                        </div>
