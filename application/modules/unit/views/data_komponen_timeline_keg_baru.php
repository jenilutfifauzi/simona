                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="<?php echo base_url(); ?>unit/kelola_kegiatan_timeline_keg_baru/<?php echo $users['kode_kom']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Pilih </a>
                          
                          <!-- <a href="<?php echo base_url(); ?>unit/submit_kegiatan/<?php echo $users['kode_kom']; ?>" class="btn btn-success"><i class="fa fa-paper-plane"></i> Submit </a>
