  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="<?= base_url('unit/aksi_tambah_data_dukung_keg_baru') ?>" class="needs-validation" enctype="multipart/form-data">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="hidden" class="form-control" id="kode" name="kode" value="<?php
                                                                                      echo $kode_subkomponen; ?>" readonly>
            </div>
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="<?= base_url('unit/aksi_tambah_rab_keg_baru') ?>" class="needs-validation">
          <div class="form-group row">
            <!-- <label for="inputKode" class="col-sm-2 col-form-label">Kode -->
            </label>
            <div class="col-sm-10">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <br>
                <td><button type="button" class="btn btn-primary col-1" data-toggle="modal" data-target="#exampleModal">
                    Tambah
                  </button></td><br>
                          ...
                          <tr>
                            ...
                            <td>
                              <center><a href="<?php echo base_url(); ?>unit/edit_rab/<?php echo $users['id']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                <a href="<?php echo base_url(); ?>unit/delete_rab/<?php echo $users['id']; ?>" class="btn btn-danger "> <i class="fas fa-trash"></i></a>
                              </center>
                            </td>
                          </tr>
                        <?php endforeach; ?>
