<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-clock"></i> <span>Kelola Waktu PIN</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?php echo base_url('admin/durasi_pin') ?>">Durasi PIN</a></li>
                </ul>
              </li>

              <li class="nav-item ">
                <a href="<?php echo base_url('admin/durasilogin') ?>" class="nav-link"><i class="fas fa-user-clock"></i> <span>Kelola Durasi Login</span></a>
              </li>
