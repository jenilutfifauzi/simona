                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if ($users['status'] == '2' or 1) { ?>
                            <a href="<?php echo base_url(); ?>pencairan/form_validasi_terima_uang/<?php echo $users['kode']; ?>" class="btn btn-primary"><i class="fas fa-check-circle"></i> Penyerahan Uang </a>
                            <?php } ?>
                          </td>
                        </tr>
                        <?php endforeach; ?>
